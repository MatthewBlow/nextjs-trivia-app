  ...
  return (
    <div>
      ...
      <form onSubmit={submitHandler}>
        <SelectField options={categories.trivia_categories} setParam={setCategory} label="Category" />
        <SelectField options={difficultyOptions} setParam={setDifficulty} label="Difficulty" />
